    ...
    <aside className="w-64 border-r border-border bg-card flex flex-col h-screen fixed left-0 top-0">
      <div className="p-6 border-b border-border">
        <h1 className="text-xl tracking-tight" style={{ fontFamily: 'var(--font-heading)' }}>
          <span className="font-extrabold text-primary">Cal</span>
          <span className="font-extrabold text-foreground">endar</span>
      ...
      <div className="p-4 border-t border-border">
        <p className="text-xs text-muted-foreground">Self-hosted scheduling</p>
      </div>
    </aside>
  );
}
